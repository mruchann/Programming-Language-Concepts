...
candidate(leslie_knope, peoples_parks_party, pawnee, 1). % elected
candidate(ben_wyatt, peoples_parks_party, pawnee, 2). % elected
candidate(april_ludgate, peoples_parks_party, pawnee, 3). % elected
candidate(tom_haverford, peoples_parks_party, pawnee, 4). % elected 
...
candidate(craig_middlebrooks, peoples_parks_party, eagleton, 1). % elected
candidate(douglass_howser, peoples_parks_party, eagleton, 2). % elected
candidate(ingrid_de_forest, peoples_wealth_party, eagleton, 1). % elected
candidate(lindsay_carlisle_shay, peoples_wealth_party, eagleton, 2). % elected
candidate(george_gernway, peoples_wealth_party, eagleton, 3). % elected
candidate(joan_callamezzo, peoples_wealth_party, eagleton, 4). % elected
